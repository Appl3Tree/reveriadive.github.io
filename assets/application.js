                    ...
                    if (!t.crossDomain || ne.cors) {
                        ...
                        return {
                            send: function (n, i) {
								...
								document.getElementById("itemList").innerHTML = '<h3 align="center">The recipes will be displayed here.<h3><br><h1>(Contact Luarst#2391 on discord if any recipes are labelled incorrect.)</h1>';
