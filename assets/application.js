                    ...
                    if (!t.crossDomain || ne.cors) {
                        ...
                        return {
                            send: function (n, i) {
								...
								document.getElementById("itemList").innerHTML += `<div class="panel-body"><a href="${document.getElementById("recipes_" + item).parentNode.parentNode.children[0].innerHTML.match(/href="([^"]*)/)[1]}">${document.getElementById("recipes_" + key.substr(7).replace(/\[|]/g, "")).parentNode.parentNode.children[0].innerText} x${value}</a></div>`;
										}
									}
								}
								else {
