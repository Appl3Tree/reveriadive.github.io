                    ...
                    if (!t.crossDomain || ne.cors) {
                        ...
                        return {
                            send: function (n, i) {
								...
								console.log(`5 ${Object.values(recipes)[item + 400][0]} : ${document.getElementById("recipes_" + key.substr(7).replace(/\[|]/g, "")).parentNode.parentNode.children[0].innerText}`);
								console.log(`6 ${Object.values(recipes)[item + 400][1]}`);	
								}
