                    ...
                    if (!t.crossDomain || ne.cors) {
                        ...
                        return {
                            send: function (n, i) {
								...
								console.log(items[0])
								console.log(items[document.getElementById("recipes_" + key.substr(7).replace(/\[|]/g, ""))]);
