                    ...
                    if (!t.crossDomain || ne.cors) {
                        ...
                        return {
                            send: function (n, i) {
								...
								document.getElementById("itemList").innerHTML = '<h3 align="center">The recipes will be displayed here.<h3>';
								...
								document.getElementById("itemList").innerHTML.replace(document.getElementById("itemList").innerHTML, document.getElementById("itemList").innerHTML + `<ol><li style="list-style-type:disc">${item_list[itemrecipe]} ×${item_amount[itemrecipe] * value}</li></ol>`)
										}
									}
								}
								else {
